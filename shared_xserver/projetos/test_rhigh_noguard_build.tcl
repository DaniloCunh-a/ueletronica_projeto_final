...
# terminals by pc + m1 pads (same style as working test_rhigh)
...
# substrate tie labeled VSS to force resistor body node name
...
save test_rhigh_noguard
extract do local
extract all
ext2spice lvs
ext2spice cthresh 0
ext2spice extresist on
ext2spice -o /home/designer/shared/projetos/test_rhigh_noguard_extracted.spice
quit -noprompt
