...
# define an explicit substrate rail labeled 'sub'
...
save test_rhigh_sublabel
extract do local
extract all
ext2spice cthresh 0
ext2spice extresist on
ext2spice -o /home/designer/shared/projetos/test_rhigh_sublabel_extracted.spice
quit -noprompt
